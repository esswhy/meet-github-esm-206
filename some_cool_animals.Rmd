...
Here's where I want to have information on ringtails.

![Photo: Ringtail cate courtesy of VA Zoo](img/ringtail_cat.jpg)

We'll also learn about `knitr::include_graphics()`

Add a few fun facts:
- They can rotate their hind feet 180 degrees, which makes then really awesome at climbing
- They are not an endangered species, but they're just very elusive
- They are closely related to raccoon 
